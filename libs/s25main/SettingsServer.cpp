...
const int SettingsServer::VERSION = 0;
const std::array<std::string, 11> SettingsServer::SECTION_NAMES = {
  {"global", "video", "language", "driver", "sound", "lobby", "server", "proxy", "interface", "ingame", "addons"}};

const std::array<short, 13> SettingsServer::SCREEN_REFRESH_RATES = {
